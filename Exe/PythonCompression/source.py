...
def __main__():
    ...
    gzip_compressed_path = GZip.compress(file_path, DataUnits.KiloByte)
    bzip2_compressed_path = BZip2.compress(file_path, DataUnits.KiloByte)
    
    GZip.decompress(gzip_compressed_path)
    BZip2.decompress(bzip2_compressed_path)
